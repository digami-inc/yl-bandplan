    ...
    iaru: [
      {
        ...
        bw: 200,
        mode: "yellow",
        desc: "CW, QRSS and narrow band digital modes",
      },
    ],
  },
  {
    ...
    iaru: [
      { from: "472", to: "475", bw: 200, mode: "yellow", desc: "CW" },
      {
        ...
        mode: "yellow",
        desc: "CW, digimodes",
        note: "maximum bandwidth not specified, 500 Hz suggested",
      },
    ],
    iaruNotes: [
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        bw: 2700,
        mode: "blue",
        desc: "All modes, digimodes",
        note: "* Lowest dial setting for LSB Voice mode: 1843",
      },
    ...
    iaru: [
      {
        ...
        bw: 200,
        mode: "yellow",
        desc: "CW, priority for intercontinental operation",
      },
      {
        from: "3510",
        to: "3560",
      ...
      { from: "3560", to: "3570", bw: 200, mode: "yellow", desc: "CW" },
      {
        ...
        bw: 200,
        mode: "yellow",
        desc: "Narrow band modes - digimodes",
      },
      {
        from: "3580",
        to: "3590",
      ...
      },
      {
        ...
        bw: 500,
        mode: "orange",
        desc: "Narrow band modes - digimodes, automatically controlled data stations (unattended)",
      },
      {
        from: "3600",
        to: "3620",
        bw: 2700,
        mode: "blue",
        desc: "All modes - digimodes, automatically controlled data station (unattended)",
        note: "* Lowest dial setting for LSB Voice mode: 3603",
      },
      {
        from: "3600",
        to: "3650",
        bw: 2700,
        mode: "blue",
        desc: "All modes, SSB contest preferred",
        note: "* Lowest dial setting for LSB Voice mode: 3603",
      },
      ...
      },
      {
        ...
        bw: 2700,
        mode: "blue",
        desc: "All modes, SSB contest preferred, priority for intercontinental operation",
      },
    ],
    bookmarks: [
      ...
      {
        pos: "3677",
        name: "YL Apaļais galds (sestdienu rītos 9:00 pēc Latvijas laika)",
      },
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        bw: 2700,
        mode: "blue",
        desc: "All modes, USB recommended for voice operation",
      },
      {
        from: "5366",
        to: "5366.5",
        bw: 20,
        mode: "yellow",
        desc: "Weak signal narrow band modes",
      },
    ],
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        bw: 2700,
        mode: "blue",
        desc: "All modes - digimodes, automatically controlled data stations (unattended)",
        note: "* Lowest dial setting for LSB Voice mode: 7053",
      },
      {
        from: "7053",
        to: "7060",
      ...
      },
      {
        ...
        bw: 2700,
        mode: "blue",
        desc: "All modes, SSB contest preferred, priority for intercontinental activity",
      },
    ],
    bookmarks: [
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        bw: 0,
        mode: "red",
        desc: "International beacon project - beacons exclusively",
      },
      {
        from: "14101",
        to: "14112",
      ...
      },
      {
        ...
        bw: 2700,
        mode: "blue",
        desc: "All modes, priority for DX-peditions",
      },
      {
        from: "14200",
        to: "14300",
      ...
      },
      {
        ...
        mode: "blue",
        desc: "All modes",
        note: "* Highest dial setting for USB voice mode: 14347",
      },
    ],
    bookmarks: [
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        mode: "blue",
        desc: "All modes",
        note: "* Highest dial setting for USB voice mode: 18165",
      },
    ],
    bookmarks: [
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        mode: "blue",
        desc: "All modes",
        note: "* Highest dial setting for USB voice mode: 21447",
      },
    ],
    bookmarks: [
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        mode: "blue",
        desc: "All modes",
        note: "* Highest dial setting for USB voice mode: 24987",
      },
    ],
    bookmarks: [
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        bw: 0,
        mode: "red",
        desc: "International beacon project - regional time shared beacons, exclusively",
      },
      {
        from: "28199",
        to: "28201",
        bw: 0,
        mode: "red",
        desc: "International beacon project - worldwide time shared beacons, exclusively",
      },
      {
        from: "28201",
        to: "28225",
        bw: 0,
        mode: "red",
        desc: "International beacon project - continuous duty beacons, exclusively",
      },
      {
        from: "28225",
        to: "28300",
      ...
      },
      {
        ...
        bw: 6000,
        mode: "green",
        desc: "All modes - FM simplex, 10 kHz channels",
      },
      {
        from: "29200",
        to: "29300",
      ...
      { from: "29510", to: "29520", bw: 0, mode: "red", desc: "Guard channel" },
      {
        ...
        bw: 6000,
        mode: "green",
        desc: "All modes - FM repeater input (RH1-RH8)",
      },
      {
        from: "29590",
        to: "29610",
        bw: 6000,
        mode: "green",
        desc: "All modes - FM calling channel",
      },
      {
        from: "29610",
        to: "29620",
        bw: 6000,
        mode: "green",
        desc: "All modes - FM simplex-repeater (parrot, input+output)",
      },
      {
        from: "29620",
        to: "29700",
        bw: 6000,
        mode: "green",
        desc: "All modes - FM repeater output (RH1-RH8)",
      },
    ],
    bookmarks: [
    ...
    iaru: [
      {
        ...
        bw: 0,
        mode: "red",
        desc: "Coordinated Beacon Project",
        note: "000 - 010 Region 1, 010-020 Region 2, 020-030 Region 3",
      },
      {
        from: "50030",
        to: "50100",
      ...
      },
      {
        ...
        bw: 2700,
        mode: "blue",
        desc: "SSB & Telegraphy, Intercontinental",
      },
      {
        from: "50130",
        to: "50200",
        bw: 2700,
        mode: "blue",
        desc: "SSB & Telegraphy, International",
      },
      {
        from: "50200",
        to: "50300",
      ...
      },
      {
        ...
        mode: "orange",
        desc: "MGM & Telegraphy",
        note: "Beacons exclusive (50.401 MHz +/- 500Hz WSPR Beacons",
      },
      {
        from: "50500",
        to: "52000",
    ...
    iaru: [
      {
        ...
        bw: 500,
        mode: "yellow",
        desc: "MGM & Telegraphy - Coordinated beacons",
      },
      {
        from: "70090",
        to: "70100",
        bw: 500,
        mode: "yellow",
        desc: "MGM & Telegraphy - Temporary and personal beacons",
        note: "70.091 Personal WSPR beacons",
      },
      {
        from: "70100",
        to: "70250",
      ...
      { from: "70250", to: "70294", bw: 12000, mode: "green", desc: "AM, FM" },
      {
        ...
        bw: 12000,
        mode: "green",
        desc: "FM Channels 12.5 KHz spacing",
      },
    ],
  },
  {
    ...
    iaru: [
      {
        ...
        bw: 2700,
        mode: "red",
        desc: "All mode, Satelite downlink only",
      },
      {
        from: "144.025",
        to: "144.1",
      ...
      },
      {
        ...
        bw: 500,
        mode: "red",
        desc: "Telegrapy & MGM, Beacons only",
      },
      {
        from: "144.491",
        to: "144.493",
      ...
      },
      {
        ...
        bw: 12000,
        mode: "green",
        desc: "MGM, Digital communication",
      },
      {
        from: "144.975",
        to: "145.194",
        bw: 12000,
        mode: "green",
        desc: "FM / DIgital Voice, Repeater input exclusive",
      },
      {
        from: "145.194",
        to: "145.206",
        bw: 12000,
        mode: "green",
        desc: "FM / Digital Voice, Space communication",
      },
      {
        from: "145.206",
        to: "145.5625",
      ...
      },
      {
        ...
        bw: 12000,
        mode: "green",
        desc: "FM / Digital Voice, Repeater output exclusive",
      },
      {
        from: "145.794",
        to: "145.806",
      ...
      },
      {
        ...
        bw: 12000,
        mode: "green",
        desc: "All Mode, Satellite exclusive",
      },
    ],
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        bw: 500,
        mode: "red",
        desc: "MGM & Telegraphy, beacons exclusive",
      },
      {
        from: "432.491",
        to: "432.493",
      ...
      },
      {
        ...
        bw: 12000,
        mode: "green",
        desc: "FM / Digital voice repeaters",
      },
      {
        from: "433.4",
        to: "433.575",
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        bw: 500,
        mode: "red",
        desc: "MGM & Telegraphy beacons (reserved for the future)",
      },
      {
        from: "1240.75",
        to: "1241.0",
        bw: 20000,
        mode: "green",
        desc: "FM/Digital Voice (reserved for the future)",
      },
      {
        from: "1241.0",
        to: "1243.25",
  ...
  },
  {
    ...
    iaru: [
      ...
      },
      {
        ...
        bw: 20000,
        desc: "FM / Digital Voice",
        note: "Voice simplex and repeaters",
      },
      { from: "2322.000", to: "2400.000", mode: "blue", desc: "all modes" },
      {
        ...
        to: "2450.000",
        mode: "blue",
        desc: "amateur sattelite service",
      },
    ],
  },
  {
    ...
    privileges: [
      {
        name: "A",
        classes: ["a"],
        slices: [{ from: "3.400", to: "3.410", mode: "green" }],
      },
    ],
    rules: [
      {
    ...
    iaru: [
      ...
      },
      {
        ...
        mode: "red",
        desc: "N/A",
        note: "YL stacijām šī IARU diapazona daļa nav atļauta",
      },
    ],
  },
  {
    ...
    privileges: [
      {
        name: "A",
        classes: ["a"],
        slices: [{ from: "5.650", to: "5.850", mode: "green" }],
      },
    ],
    rules: [
      {
    ...
    iaru: [
      ...
      { from: "5762.000", to: "5790.000", mode: "blue", desc: "all modes" },
      {
        ...
        mode: "red",
        desc: "all modes",
        note: "Amateur Satellite service (down link)",
      },
    ],
  },
  {
    ...
    privileges: [
      {
        name: "A",
        classes: ["a"],
        slices: [{ from: "10.000", to: "10.500", mode: "green" }],
      },
    ],
    rules: [
    ...
    iaru: [
      ...
      },
      {
        ...
        mode: "blue",
        desc: "all modes",
        note: "AMATEUR SATELLITE SERVICE",
      },
    ],
  },
  {
    ...
    privileges: [
      {
        name: "A",
        classes: ["a"],
        slices: [{ from: "24", to: "24.05", mode: "green" }],
      },
    ],
    rules: [
    ...
    iaru: [
      ...
      },
      {
        ...
        mode: "yellow",
        desc: "All modes",
        note: "Amateur Satellite service, Narrow band modes",
      },
      {
        from: "24048.800",
        to: "24048.995",
    ...
    privileges: [
      {
        name: "A",
        classes: ["a"],
        slices: [{ from: "47", to: "47.2", mode: "green" }],
      },
    ],
    rules: [
    ...
    privileges: [
      {
        name: "A",
        classes: ["a"],
        slices: [{ from: "76", to: "81.1", mode: "green" }],
      },
    ],
    rules: [
    ...
    iaru: [
      {
        ...
        mode: "red",
        desc: "All modes",
        note: "YL stacijām šī IARU diapazona daļa nav atļauta / AMATEUR SATELLITE SERVICE (Preferred) ",
      },
    ...
    privileges: [
      {
        name: "A",
        classes: ["a"],
        slices: [{ from: "122.250", to: "123.000", mode: "green" }],
      },
    ],
    rules: [
    ...
    privileges: [
      {
        name: "A",
        classes: ["a"],
        slices: [{ from: "134", to: "141", mode: "green" }],
      },
    ],
    rules: [
    ...
    privileges: [
      {
        name: "A",
        classes: ["a"],
        slices: [{ from: "241", to: "250", mode: "green" }],
      },
    ],
    rules: [
