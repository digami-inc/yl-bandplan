<template>
  <div class="card card--topmargin">
    <div class="card-content">
      ...
      <p>Dati ņemti no:</p>
      <ul>
          <li><a href="https://www.iaru-r1.org/reference/band-plans/">IARU R1 Band Plans (www.iaru-r1.org)</a></li>
          <li><a href="https://likumi.lv/ta/id/284085-radioamatieru-radiostaciju-buvesanas-ierikosanas-un-lietosanas-ka-ari-radioamatieru-apliecibas-sanemsanas-kartiba">Radioamatieru radiostaciju būvēšanas, ierīkošanas un lietošanas, kā arī radioamatieru apliecības saņemšanas kārtība (likumi.lv)</a></li>
      </ul>
